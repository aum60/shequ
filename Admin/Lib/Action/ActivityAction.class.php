...
//            $order = !empty($sortBy) ? $sortBy : $model->getPk();
        ...
        if ($list) {
            foreach ($list as &$v) {
                ...
                //参加活动人数
                $v['join_num'] =  $v['join_num'] ? $v['join_num'] : 0;
                //查询分类信息
                ...
                //参加活动的权限
                $v['auth'] = $this->AUTH[$v['auth']];

                //活动帖子数
                $v['activity_message_num'] = $v['activity_message_num'] ? $v['activity_message_num'] : 0;
...
//        echo $return;
    ...
    public function data_add() {
        ...
        if ($_POST) {
            ...
            $_POST['type'] = $_POST['sstatus'] ? 1 : 0;
            $_POST['auth'] = $_POST['auth'] ? 1 : 2;
            $_POST['user_from'] = $_SESSION[C('USER_AUTH_KEY')]['id'];
            $_POST['add_time'] = time();
            $_POST['cat_id'] = $_POST['pid'];
