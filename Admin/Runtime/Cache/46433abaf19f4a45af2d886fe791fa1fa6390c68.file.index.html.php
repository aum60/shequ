<?php /* Smarty version Smarty-3.1.6, created on 2017-06-06 13:09:37
         compiled from "./Admin/Tpl\Index\index.html" */ ?>
<?php /*%%SmartyHeaderCode:170559360ef78aac54-47167373%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '170559360ef78aac54-47167373',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_59360ef7f0f95',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59360ef7f0f95')) {function content_59360ef7f0f95($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'D:\\pro\\bbs_admin\\ThinkPHP\\Extend\\Vendor\\Smarty\\plugins\\modifier.date_format.php';
...
<body scroll="no">
	<div id="layout">
		<div id="header">
			<div class="headerNav">
				<a class="logo" href="#" style="background:none;">标志</a>
				<ul class="nav">
		...
		<div id="leftside">
			...
			<div id="sidebar">
				...
				<div class="accordion" fillSpace="sidebar">
						...
						<h2><span>Folder</span>论坛信息管理</h2>
					</div>
					<div class="accordionContent">
						<ul class="tree treeFolder">
                                                    <li><a href="__APP__/Message/index" target="navTab" rel="listmessage" title="帖子列表" >帖子列表</a></li>
                                                    <li><a href="__APP__/Comm/index" target="navTab" rel="listcomm" title="帖子评论列表">帖子评论列表</a></li>
                                                    <li><a href="__APP__/Message/global_config" target="navTab" rel="listcomm" title="帖子设置">帖子设置</a></li>
						</ul>
					</div>
                    ...
                    <div class="accordionContent">
                        <ul class="tree treeFolder">
                            <li><a href="__APP__/Activity/index" target="navTab" rel="listlib" title="查看活动" >查看活动</a></li>
                        </ul>
                    </div>
...
<!--                    <div class="accordionHeader">
						<h2><span>Folder</span>首页轮播图管理</h2>
					</div>
					<div class="accordionContent">
						<ul class="tree treeFolder">
                            <li><a href="__APP__/Notice/index" target="navTab" rel="listnotice" title="首页轮播图列表" >首页轮播图列表</a></li>
                            <li><a href="__APP__/Notice/add" target="dialog" width="1200" height="900" title="添加首页轮播图">添加首页轮播图</a></li>
						</ul>
                    </div>-->
                                    <div class="accordionHeader">
					...
					<div class="accordionContent">
						<ul class="tree treeFolder">
                            <li><a href="__APP__/Cat/index" target="navTab" rel="listcat" title="分类列表" >分类列表</a></li>
                    ...
                    <div class="accordionHeader">
						<h2><span>Folder</span>系统消息管理</h2>
					</div>
					<div class="accordionContent">
						<ul class="tree treeFolder">
							<li><a href="__APP__/SysNewsManagement/index" target="navTab" rel="listlib" title="系统消息列表" >系统消息列表</a></li>
							<!--<li><a href="__APP__/Users/add" target="dialog" width="500" height="500">添加用户信息</a></li>-->
						</ul>
                    </div>
                    <div class="accordionHeader">
						<h2><span>Folder</span>推送管理</h2>
					</div>
					<div class="accordionContent">
						<ul class="tree treeFolder">
							<li><a href="__APP__/PictureManagement/index" target="navTab" rel="listlib" title="首页轮播图列表" >首页轮播图列表</a></li>
						</ul>
                    </div>
                    <div class="accordionHeader">
                    <h2><span>Folder</span>浏览量管理</h2>
					</div>
					<div class="accordionContent">
						<ul class="tree treeFolder">
							<li><a href="__APP__/Viewnum/index" target="navTab" rel="listlib" title="浏览量数值" >浏览量数值</a></li>
						</ul>
                    </div>
  ...
  <tr height=100>
    ...
    <td>
      <table height=100 cellSpacing=0 cellPadding=0 width="100%" border=0>
        ...
        <tr>
          <td>欢迎进入论坛管理系统！</td></tr></table></td></tr>
        <tr>
