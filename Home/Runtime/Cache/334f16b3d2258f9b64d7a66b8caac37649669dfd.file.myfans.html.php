<?php /* Smarty version Smarty-3.1.6, created on 2017-06-05 18:19:07
         compiled from "./Home/Tpl\Ucenter\myfans.html" */ ?>
<?php /*%%SmartyHeaderCode:178605935301b6d4037-33438183%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '334f16b3d2258f9b64d7a66b8caac37649669dfd' => 
    array (
      0 => './Home/Tpl\\Ucenter\\myfans.html',
      1 => 1496657918,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '178605935301b6d4037-33438183',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5935301bd6b9c',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5935301bd6b9c')) {function content_5935301bd6b9c($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'D:\\pro\\new\\ThinkPHP\\Extend\\Vendor\\Smarty\\plugins\\modifier.truncate.php';
...
<div class="ina_silde">
    <div class="ina_author">
        ...
        <div class="ina_centerbt">
            <h3>共<?php echo $_smarty_tpl->tpl_vars['count']->value;?>
位粉丝</h3>
        </div>
...
?>
            <dl>
                <dt>
                    <a href="__APP__/Ucenter/uspace/uid/<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
" target="_blank"><img src="<?php echo $_smarty_tpl->tpl_vars['v']->value['picture_path'];?>
"></a>
                    <span class="ina_sex"><i class="ina_icon <?php if ($_smarty_tpl->tpl_vars['v']->value['sex']=='1'){?>ina_man<?php }else{ ?>ina_women<?php }?>"></i></span>
                </dt>
                <dd>
                    <a href="__APP__/Ucenter/uspace/uid/<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
" target="_blank" style="padding:10px;">
                    <h3><?php echo $_smarty_tpl->tpl_vars['v']->value['username'];?>
</h3>
                    </a>
                    <ul>
                        <li><span>发帖</span><a href="__APP__/Ucenter/uspace/uid/<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
" target="_blank"><?php echo $_smarty_tpl->tpl_vars['v']->value['num_data'][0];?>
</a></li>
                        <li><span>关注</span><a href="__APP__/Ucenter/uspace/uid/<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
" target="_blank"><?php echo $_smarty_tpl->tpl_vars['v']->value['num_data'][1];?>
</a></li>
                        <li class="ina_last"><span>粉丝</span><a href="__APP__/Ucenter/uspace/uid/<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
" target="_blank"><?php echo $_smarty_tpl->tpl_vars['v']->value['num_data'][2];?>
                ...
                <div class="ina_dl_edit">
                    <a href="javascript:;;" uid="<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
" types="list" class="<?php if ($_smarty_tpl->tpl_vars['v']->value['like']=='y'){?>quxiao ina_huguanzhu<?php }else{ ?>ina_jia tianjiagz<?php }?>">
                        <i class="ina_icon"></i>
                        <b><?php if ($_smarty_tpl->tpl_vars['v']->value['like']=='y'){?>互关注<?php }else{ ?>加关注<?php }?></b>
                        <em>取&nbsp;&nbsp;消</em>
                    </a>
                </div>
            </dl>
        ...
        <?php }else{ ?>
        <div class="ina_boxno">
            <img src="http://img.news18a.com/community/image/fans.jpg">
            <span>竟然没有粉丝，要饿死我么？<a href="__APP__/Index/add" target="_blank">发帖</a>拉粉去</span>
        </div>
        <?php }?>
    </div>
</div>
