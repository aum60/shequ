<?php /* Smarty version Smarty-3.1.6, created on 2017-06-05 18:19:09
         compiled from "./Home/Tpl\Index\add.html" */ ?>
<?php /*%%SmartyHeaderCode:53405935301d1988a9-00213375%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a1763c172f86e81bf00ad75d2ce5c0f14932d966' => 
    array (
      0 => './Home/Tpl\\Index\\add.html',
      1 => 1496375542,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '53405935301d1988a9-00213375',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5935301dcb85c',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5935301dcb85c')) {function content_5935301dcb85c($_smarty_tpl) {?><!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html lang="en">
<head>
...
" + data_str.pic + "' />");
            ...
            //$("#cropbox_1").attr('src','<?php echo $_smarty_tpl->tpl_vars['ftp_img_path']->value;?>
' + data);
        ...
        if (parseInt($('#w_1').val())){
            ...
            $.post("__APP__/Index/cut_pic_size",
                ...
                if(res==1000){
                    ...
                    $("#cut_pic_1").slideUp(500);
                    $("#is_cuts").val(1);
                    $("#pic_show_2").html("<img src='<?php echo $_smarty_tpl->tpl_vars['ftp_img_path']->value;?>
" + res + "' width='270' height='180'>")
